...
def internet_on():
    try:
        urllib2.urlopen('http://216.58.192.142', timeout=0.5)
        return True
...
def sound_list_service(req):
    if expanduser("~") == "/home/aldenparker" or expanduser("~") == "/home/di3mas":
        cwd = expanduser("~") + '/PycharmProjects/br-core/catkin_ws/src/br-behavior-engine/src/'
    else:
        cwd = expanduser("~") + '/Github/br-core/catkin_ws/src/br-behavior-engine/src/'
...
class program:
    ...
    def __init__(self, fr, tick, fps, bs):
        if expanduser("~") == "/home/aldenparker" or expanduser("~") == "/home/di3mas":
            self.cwd = expanduser("~") + '/PycharmProjects/br-core/catkin_ws/src/br-behavior-engine/src/'
        else:
            self.cwd = expanduser("~") + '/Github/br-core/catkin_ws/src/br-behavior-engine/src/'
...
class spotify_session:
    ...
    def __init__(self):
        try:
            os.environ["SPOTIPY_CLIENT_ID"] = "22abcf8d1c17460f9f6ccac863235adc"
            os.environ["SPOTIPY_CLIENT_SECRET"] = "66be1f9f62ec43bda20b633cd0506e78"
            os.environ["SPOTIPY_REDIRECT_URI"] = "https://garbagebytes.com"
            ...
            self.session = spotipy.Spotify(auth=token, client_credentials_manager=SpotifyClientCredentials())
...
if __name__ == '__main__':
    ...
    # parser.add_argument('--tick', help='Show Clock Tick', action='store_true')
    # parser.add_argument('--fps', help='Show Clock FPS', action='store_true')
    ...
    os.system("spotify &")  # Open Spotify
    ...
    # Create program
    prog = program(frame_rate, True, True, blink_speed)
