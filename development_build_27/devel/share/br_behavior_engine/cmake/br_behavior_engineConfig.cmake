...
if(NOT "/home/travis/build/BytesRobotics/br-core/catkin_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'br_behavior_engine' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/travis/build/BytesRobotics/br-core/catkin_ws/src/br-behavior-engine/${idir}'.  ${_report}")
    endif()
